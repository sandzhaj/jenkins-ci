...
pipelineJob("service-jobs/docker-env/docker-build-regression-dsl") {
...
parameters {
    ...
    description('')
        choices(["None", "Dockerfile-rspec-regression"])
    }
    stringParam('TAG', '1.0', '')      
}
...
definition {
    ...
    scriptPath('jobs/pipeline/docker-build-regression')
    }
}
}